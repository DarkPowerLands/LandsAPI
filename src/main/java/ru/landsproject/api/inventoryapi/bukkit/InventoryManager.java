package ru.landsproject.api.inventoryapi.bukkit;

import ru.landsproject.api.inventoryapi.bukkit.content.InventoryContents;
import ru.landsproject.api.inventoryapi.bukkit.opener.ChestInventoryOpener;
import ru.landsproject.api.inventoryapi.bukkit.opener.InventoryOpener;
import ru.landsproject.api.inventoryapi.bukkit.opener.SpecialInventoryOpener;
...
public class InventoryManager {
    ...
    private Map<UUID, BasicInventory> inventories;
    ...
    public List<Player> getOpenedPlayers(BasicInventory inv) {
    ...
    public Optional<BasicInventory> getInventory(Player p) {
        return Optional.ofNullable(this.inventories.get(p.getUniqueId()));
    }

    protected void setInventory(Player p, BasicInventory inv) {
        if (inv == null)
    ...
    public void handleInventoryOpenError(BasicInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while opening BasicInventory:", exception);
    }

    public void handleInventoryUpdateError(BasicInventory inventory, Player player, Exception exception) {
        inventory.close(player);

        Bukkit.getLogger().log(Level.SEVERE, "Error while updating BasicInventory:", exception);
    }
    ...
    class InvListener implements Listener {
        ...
        public void onInventoryClick(InventoryClickEvent e) {
            ...
            if (clickedInventory == p.getOpenInventory().getTopInventory()) {
                ...
                BasicInventory inv = inventories.get(p.getUniqueId());
