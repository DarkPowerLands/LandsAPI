package ru.landsproject.api.inventoryapi.bukkit.content;
...
public interface SlotIterator {
    ...
    class Impl implements SlotIterator {
        ...
        public Impl(InventoryContents contents, BasicInventory inv,
        ...
        public Impl(InventoryContents contents, BasicInventory inv, Type type, Integer startSlot) {
            this(contents, inv, type, startSlot / 9, startSlot % 9);
        }
        @Override
